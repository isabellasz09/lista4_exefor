#Você é um desenvolvedor de sistemas trabalhando em um projeto para um salão de beleza.
# O salão precisa de um sistema para gerenciar os horários de atendimento dos clientes. 
# Primeiro, a dona do salão monta a grade horária da agenda. Depois, uma cliente deseja agendar um horário, 
# e o sistema exibe os horários disponíveis. 
